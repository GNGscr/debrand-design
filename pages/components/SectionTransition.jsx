          ...
          className={`sticky top-0 h-screen bg-black text-[3.25vw] flex flex-col
            ...
            <div className="about-content flex gap-[10rem] mt-[1rem]">
                ...
                <div className="right-section flex flex-col">
                    <div className="about-me-title mt-[0.5rem] mb-[0.5rem] text-[1.75rem]">As a Creative Developer..</div>
                    <div className="about-me-title mt-[1rem] mb-[1rem] text-[1.5rem] flex flex-wrap w-[25rem]">
